...
const Hero = () => {
  return (
    <section className="flex flex-col">
      ...
      <div className="text-zinc-400 text-sm flex flex-col gap-4 underline">
        <p className="flex items-center gap-2">
          <BiSolidEnvelope className="text-zinc-100" size={18} />{" "}
          okicramo9@gmail.com
        </p>
        <p className="flex items-center gap-2">
          <BiLogoLinkedin className="text-zinc-100" size={18} />{" "}
          linkedin.com/in/ramookic
        </p>
        <p className="flex items-center gap-2">
          <BiLogoGithub className="text-zinc-100" size={18} />{" "}
          github.com/ramookic
        </p>
      </div>
    </section>
